...
<body>
    ...
    <div class="preloader">
        <div class="preloader-logo"><img src='{{ URL::asset("uploads/logo/$setting->logo_image") }}' alt=""
                width="250" height="85" srcset='{{ URL::asset("uploads/logo/$setting->logo_image") }} 2x' />
        </div>
                        ...
                        <div class="rd-navbar-aside">
                            ...
                            <div class="rd-navbar-panel">
                                ...
                                <!-- RD Navbar Brand--><a class="rd-navbar-brand" href="/"><img
                                        ...
                                        width="195" height="85"
                                        srcset="{{ URL::asset("uploads/logo/$setting->logo_image") }} 2x" /></a>
                            </div>
                    ...
                    <div class="footer-advanced-layout">
                        <div>
                            <ul class="list-nav">
                                ...
                                <li><a href="{{ route('.projects') }}">Our Projrcts</a></li>
            ...
            <div class="footer-advanced-aside">
                <div class="container">
                    <div class="footer-advanced-layout"><a class="brand" href="/"><img
                                src='{{ URL::asset("uploads/logo/$setting->logo_image")}}' alt="" width="195" height="85"
                                srcset='{{ URL::asset("uploads/logo/$setting->logo_image")}} 2x' /></a>
                        <!-- Rights-->
