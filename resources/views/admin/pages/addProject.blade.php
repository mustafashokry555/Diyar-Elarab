            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    ...
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">Projects (Add New Project)</h5>
                    </div>
                    <div class="card-body">
                        <form enctype="multipart/form-data" action="{{ route('admin.storeProject') }}" method="POST">
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text"  placeholder="Description" class="form-control"  id="basic-default-title2"
                                    ...
                                    @if (!empty($project->imgs))    
                                        @foreach ($project->imgs as $img)
                                            <span style='width: 24%; height: 170px;' class="text-center mb-2 d-inline-block">
                                                ...
                                                <input class="form-control"  name="oldImgs[]" hidden value="{{ $img }}" multiple>
