...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ URL::asset('dashboard/assets/img/favicon/favicon.ico') }}" />
...
<body>
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="{{ route('admin') }}" class="app-brand-link">
                        ...
                        <img src='{{ URL::asset("uploads/logo/$setting->logo_image") }}' alt=""
                ...
                <ul id="asideNavBarUl" class="menu-inner py-1">
                    <!-- Dashboard -->
                    <li class="menu-item">
                        <a href="{{ route('admin') }}" class="menu-link active">
                            <i class="menu-icon tf-icons bx bx-home-circle"></i>
                            <div data-i18n="Analytics">Dashboard</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="{{ route('admin.pages.setting') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-cog"></i>
                            <div>Setting</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="{{ route('admin.pages.team') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-user"></i>
                            <div>Our Team</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="{{ route('admin.pages.investor') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-user"></i>
                            <div>Our Investor</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="{{ route('admin.pages.customer_review') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-user"></i>
                    ...
                    <li class="menu-item">
                        <a href="{{ route('admin.cats') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-copy"></i>
                            <div>Categories</div>
                        </a>
                    </li>
                                ...
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                    ...
                                    <div class="avatar avatar-online">
                                        @if (Auth::user()->img == null)
                                            <img src="{{ URL::asset('dashboard/assets/img/avatars/1.png') }}" alt
                                                class="w-px-40 h-auto rounded-circle" />
                                        @else
                                            <img src="{{ route(Auth::user()->img) }}" alt
                                                class="w-px-40 h-auto rounded-circle" />
                                        @endif
                                    </div>
                                </a>
                                <ul class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <a class="dropdown-item" href="#">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 me-3">
                                                    <div class="avatar avatar-online">
                                                        @if (Auth::user()->img == null)
                                                            <img src="{{ URL::asset('dashboard/assets/img/avatars/1.png') }}"
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <small
                                                        class="text-muted">{{ Auth::user()->userRole->role }}</small>
                                                </div>
                                            </div>
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <form class="dropdown-item" method="POST" action="{{ route('logout') }}">
                                            ...
                                            <button style="all: unset;" type="submit" class="align-middle">Log
                                                Out</button>
                                        </form>
                                    </li>
                                </ul>
    ...
    <script>
        $('#asideNavBarUl .menu-item .menu-link').each(function(){
            if($(this).prop('href') == location.href){
                $('#asideNavBarUl .menu-item .menu-link').parents('li , ul').removeClass('active');
